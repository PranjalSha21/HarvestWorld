  ...
  <table class="table table-bordered table-striped table-hover">
    ...
    ?>
      <tr class="align-centre">
        ...
        <td > <a href="orderview.php?id=<?php echo $row['order_id'] ?>"><button type="submit" class="btn btn-success">VIEW</button></a></td>
        <?php if($row['status']=='PENDING'){
?>
            <td > <a href="./Database/payment.php?delete_id=<?php echo $row['order_id'] ?>"><button type="submit" name="delete_product" class="btn btn-danger">CANCEL ORDER</button></a></td>
        <?php
