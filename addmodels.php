        ...
        <div class="cardbody mx-5">
                <form action="./Database/model.php" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="mb-3">
                                ...
                                <input type="text" name="m_name" class="form-control" aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
                                <label class="form-label">Description</label>
                                <Textarea type="text" name="m_description" class="form-control" TextMode="MultiLine"> </textarea>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                                ...
                                <input type="file" name="m_image" class="form-control" aria-describedby="emailHelp">
                        </div>
